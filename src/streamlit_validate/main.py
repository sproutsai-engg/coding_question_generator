...
file_path=r"C:\SaiVinay\SproutsAI\GitHub_\coding_question_generator\src\verified_coding_questions.json"
...
def main():
    ...
    if st.sidebar.button(f"Previous Question :fast_forward:"):
    ...
    if st.sidebar.button(f":rewind: Next Question"):
